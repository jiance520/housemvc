...
<div id="main">
    ...
    <div class="content1">
        ...
        <div class="content" id="left">
            <form class="form" name="form1" action="InsertAction" method="post">
                <table>
                    <tr class="tr1">
                        <td class="tdhui">&nbsp;标&nbsp;&nbsp;&nbsp;&nbsp;题:</td>
                        <td colspan="2">&nbsp;<input class="input1" type="text" name="title" value="" required/></td>
                    </tr>
                    <tr class="tr1">
                    ...
                    <tr class="tr1">
                        ...
                        <td colspan="2">&nbsp;<input class="input1" type="number" name="floorage" value="" required></td>
                    </tr>
                    <tr class="tr1">
                        <td class="tdhui">&nbsp;价&nbsp;&nbsp;&nbsp;&nbsp;格:</td>
                        <td colspan="2">&nbsp;<input class="input1" type="number" name="price" value="" required></td>
                    </tr>
                    <tr class="tr1">
                        <td class="tdhui">房产证日期:</td>
                        <td colspan="2">&nbsp;<input class="input1" type="date" name="pubdate" value=""></td>
                    </tr>
                    <tr class="tr1">
                    ...
                    <tr class="tr1">
                        ...
                        <td colspan="2">&nbsp;<input class="input1" type="tel" name="contact" value="" required></td>
                    </tr>
                    <tr class="tr1">
                        <td class="tdhui">&nbsp;详细信息:</td>
                        <td colspan="2">&nbsp;<textarea rows="6" cols="36" name="description" required></textarea>
                        </td>
                    </tr>
                    <tr class="tr">
                        <td height="30"></td>
                    ...
                    <tr class="tr">
                        <td></td>
                        <td colspan="2" class="position1"><input class="baif1" type="image" src="images/ss.jpg"><a class="bais1" href="javascript:document.form1.submit()">立即发布</a></td>
                    </tr>
                    <tr class="tr">
                        <td height="60"></td>
                        <td></td>
...
<!--         <div class="content" id="right">
            <form action="#" class="form" name="form2" method="post">
                <table>
                    <tr class="tr1">
                    ...
                    <tr class="tr">
                        <td></td>
                        <td colspan="2" class="position1"><input  class="baif1" type="image" src="images/ss.jpg"><a class="bais1" href="javascript:document.form2.submit()">立即发布</a></td>
                    </tr>
                    <tr class="tr">
                        <td height="60"></td>
                        <td></td>
